...
importScripts('./host-status.js?v=1.1.33');

const CACHE_NAME = 'grq-health-v1.1.33';
const STATIC_CACHE_NAME = 'grq-health-static-v1.1.33';
...
const STATIC_FILES = [
  ...
  './theme.css?v=1.1.19',
  './theme.js?v=1.1.19',
  './host-status.js?v=1.1.33',
  './dashboard.js?v=1.1.33',
  './medical-check.png',
  './unhealthy.png',
  './manifest.json',
  './browserconfig.xml',
